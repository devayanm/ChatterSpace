...
import { Eye, EyeOff, MessageCircle, Users, Shield, Zap, XCircle } from 'lucide-react'; // 🆕 Added XCircle for the close icon
...
const AuthPage = ({ socket, typingUtils }) => {  // ✅ Accept socket prop + typingUtils
  ...
  // ✅ Added state for the error message
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
              ...
              <div className="flex bg-white/10 rounded-xl p-1 mb-8">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all duration-200 ${isLogin
              ...
              {/* 🆕 NEW: The Alert Message Box */}
              {errorMessage && (
                <div className="mb-6 p-4 rounded-xl border border-red-500 bg-red-900/40 backdrop-blur-sm flex items-center justify-between transition-opacity duration-300 animate-fadeIn">
                  ...
                  <button onClick={() => setErrorMessage('')} className="p-1 -mr-2 text-red-300 hover:text-red-100 transition-colors duration-200">
